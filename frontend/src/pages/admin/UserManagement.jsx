...
const UserManagement = () => {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const adminUsers = usersData.filter(user => user.role === 'hod' || user.role === 'dhod').length;
  ...
  const getRoleIcon = (role) => {
    switch (role) {
      case 'hod': return <CrownOutlined />;
      case 'dhod': return <SafetyCertificateOutlined />;
            ...
            <Col span={12}>
              ...
              >
                <Select placeholder="Select user role">
                  <Option value="hod">
                    <CrownOutlined /> HoD (Head of Department)
                  </Option>
                  <Option value="dhod">
                    <SafetyCertificateOutlined /> DHoD (Deputy Head of Department)
                  </Option>
