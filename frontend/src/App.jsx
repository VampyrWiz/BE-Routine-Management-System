      ...
      <ConfigProvider
        theme={{
          ...
          token: {
            ...
            borderRadius: 8,
            wireframe: false,
            fontFamily: '"Source Sans 3", Georgia, -apple-system, BlinkMacSystemFont, system-ui, sans-serif',
            fontSize: 14,
            colorBgContainer: '#ffffff',
            colorBgElevated: '#ffffff',
            colorBgLayout: '#FBF7EE',
          ...
          components: {
            ...
            Menu: {
              itemBg: 'transparent',
              itemSelectedBg: 'linear-gradient(135deg, #C98A2B 0%, #8B6914 100%)',
              itemHoverBg: '#f5f5f5',
            },
            Card: {
              borderRadiusLG: 12,
