...
const Layout = () => {
  ...
  const publicMenuItems = [
    {
      ...
      style: {
        ...
        marginBottom: '5px',
        background: location.pathname === '/' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/program-routine' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/teacher-routine' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/room-routine' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/subjects' ? '#C98A2B' : 'transparent',
  ...
  const adminMenuItems = [
    ...
    // Removed 'Admin Panel' text as requested
    {
      ...
      style: {
        ...
        background: location.pathname === '/program-routine-manager' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/admin/meeting-scheduler' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/teachers-manager' ? '#C98A2B' : 'transparent',
    ...
    { 
      ...
      style: {
        ...
        background: location.pathname === '/programs-manager' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/subjects-manager' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/rooms-manager' ? '#C98A2B' : 'transparent',
    ...
    { 
      ...
      style: {
        ...
        background: location.pathname === '/academic-calendar-manager' ? '#C98A2B' : 'transparent',
...

    {
      ...
      style: {
        ...
        background: location.pathname === '/department-manager' ? '#C98A2B' : 'transparent',
    ...
    },
    {
      ...
      style: {
        ...
        background: location.pathname === '/timeslots-manager' ? '#C98A2B' : 'transparent',
  ...
  if (!user) {
    menuItems.push({
      ...
      label: 'Admin Login',
      style: {
        background: 'linear-gradient(135deg, #C98A2B20 0%, #8B691420 100%)',
        color: '#C98A2B',
        fontWeight: 500,
        margin: '8px',
        borderRadius: '8px'
  ...
  const userMenuItems = user ? [
    {
      key: 'profile',
      icon: <UserOutlined style={{ color: '#C98A2B', fontSize: '16px' }} />,
      label: (
        <div style={{ padding: '12px 8px' }}>
          <div style={{
            ...
            <Avatar
              ...
              src={user.avatarUrl}
              style={{
                background: (user?.role === 'hod' || user?.role === 'dhod')
                  ? 'linear-gradient(135deg, #C98A2B 0%, #8B6914 100%)'
          ...
          <div style={{
            ...
            Signed in as {roleLabels[user?.role] || 'User'}
          </div>
        </div>
      ),
      disabled: true,
        ...
        <>
          ...
          >
            ...
            <div style={{
              ...
              background: 'linear-gradient(90deg, #C98A2B 0%, #8B6914 100%)',
              color: 'white'
            }}>
              <div
                style={{
        ...
        <Header style={{
          ...
          {user ? (
            ...
            <Button
              ...
              style={{
                borderRadius: '12px',
                background: 'linear-gradient(135deg, #C98A2B 0%, #8B6914 100%)',
                border: 'none',
                fontWeight: 500,
