...
// @access  Private
router.get('/', optionalAuth, timeSlotController.getTimeSlots);

// @route   GET /api/time-slots/category/:category
// @desc    Get time slots by category
// @access  Private
router.get('/category/:category', optionalAuth, timeSlotController.getTimeSlotsByCategory);

// @route   POST /api/time-slots/initialize
// @desc    Initialize default time slots
// @access  Private/Admin
router.post('/initialize', [protect, authorize('hod', 'dhod')], timeSlotController.initializeTimeSlots);

// @route   POST /api/time-slots/reorder
// @desc    Reorder all time slots chronologically
// @access  Private/Admin
router.post('/reorder', [protect, authorize('hod', 'dhod')], timeSlotController.reorderTimeSlots);

// @route   POST /api/time-slots/context/:programCode/:semester/:section
// @desc    Create a context-specific time slot
// @access  Private/Admin
router.post('/context/:programCode/:semester/:section', [protect, authorize('hod', 'dhod'), ...timeSlotValidation], timeSlotController.createContextTimeSlot);

// @route   POST /api/time-slots
// @desc    Create a new time slot
// @access  Private/Admin
router.post('/', [protect, authorize('hod', 'dhod'), ...timeSlotValidation], timeSlotController.createTimeSlot);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), ...timeSlotValidation], timeSlotController.updateTimeSlot);

// @route   DELETE /api/time-slots/bulk
// @desc    Bulk delete time slots
// @access  Private/Admin
router.delete('/bulk', [protect, authorize('hod', 'dhod')], timeSlotController.bulkDeleteTimeSlots);

// @route   DELETE /api/time-slots/:id
// @desc    Delete time slot
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], timeSlotController.deleteTimeSlot);
