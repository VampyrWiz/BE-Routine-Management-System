...
router.post('/check-conflicts', [protect, authorize('hod', 'dhod')], routineSlotController.checkConflicts);

// @route   POST /api/routine-slots/bulk
// @desc    Bulk create routine slots
// @access  Private/Admin
router.post('/bulk', [protect, authorize('hod', 'dhod')], routineSlotController.bulkCreateRoutineSlots);

// @route   POST /api/routine-slots/elective
// @desc    Create an elective class with multiple subjects
// @access  Private/Admin
router.post('/elective', [protect, authorize('hod', 'dhod')], routineSlotController.createElectiveClass);

// @route   POST /api/routine-slots
// @desc    Create a new routine slot
// @access  Private/Admin
router.post('/', [protect, authorize('hod', 'dhod'), ...routineSlotValidation], routineSlotController.createRoutineSlot);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), ...routineSlotValidation], routineSlotController.updateRoutineSlot);

// @route   DELETE /api/routine-slots/:id
// @desc    Delete routine slot (hard delete - completely removes from database)
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], routineSlotController.deleteRoutineSlot);
