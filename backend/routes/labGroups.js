...
router.post('/', [protect, authorize('hod', 'dhod'), ...validateLabGroup], labGroupController.createLabGroup);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), ...validateLabGroup], labGroupController.updateLabGroup);

// @route   DELETE /api/lab-groups/:id
// @desc    Delete lab group
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], labGroupController.deleteLabGroup);
