 ...
 *         description: Room deleted successfully
 */
router.delete('/:id', protect, authorize('hod', 'dhod'), deleteRoom);
 ...
 *               format: binary
 */
router.get('/export/all', protect, authorize('hod', 'dhod'), exportAllRoomSchedules);
 ...
 *         description: Room not found
 */
router.get('/:id/export', protect, authorize('hod', 'dhod'), exportRoomSchedule);
