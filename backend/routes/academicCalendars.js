...
router.post('/', [protect, authorize('hod', 'dhod'), ...validateAcademicCalendar], academicCalendarController.createAcademicCalendar);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), ...validateAcademicCalendar], academicCalendarController.updateAcademicCalendar);

// @route   DELETE /api/academic-calendars/:id
// @desc    Delete academic calendar
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], academicCalendarController.deleteAcademicCalendar);
