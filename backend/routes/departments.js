...
router.post('/', [protect, authorize('hod', 'dhod'), ...validateDepartment], departmentController.createDepartment);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), ...validateDepartment], departmentController.updateDepartment);

// @route   DELETE /api/departments/:id
// @desc    Delete department (soft delete)
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], departmentController.deleteDepartment);
