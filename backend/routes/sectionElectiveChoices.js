...
router.post('/', [protect, authorize('hod', 'dhod'), validateSectionElectiveChoice], createSectionElectiveChoice);
...
// @access  Private/Admin
router.put('/:id', [protect, authorize('hod', 'dhod'), validateSectionElectiveChoice], updateSectionElectiveChoice);

// @route   PUT /api/section-elective-choices/:id/submit
// @desc    Submit section elective choice for approval
// @access  Private/Admin
router.put('/:id/submit', [protect, authorize('hod', 'dhod')], submitSectionElectiveChoice);

// @route   PUT /api/section-elective-choices/:id/approve
// @desc    Approve or reject section elective choice
// @access  Private/Admin
// Approval is an HoD-only privilege; the DHoD holds every other management right.
router.put('/:id/approve', [protect, authorize('hod'), validateApproval], approveSectionElectiveChoice);

// @route   DELETE /api/section-elective-choices/:id
// @desc    Delete section elective choice
// @access  Private/Admin
router.delete('/:id', [protect, authorize('hod', 'dhod')], deleteSectionElectiveChoice);
