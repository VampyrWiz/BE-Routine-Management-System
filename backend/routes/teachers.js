...
const { verifyToken, requireManagement, optionalAuth } = require('../middleware/auth');
 ...
 */
router.post('/bulk', verifyToken, requireManagement, teacherController.createTeachersBulk);
 ...
 */
router.delete('/bulk', verifyToken, requireManagement, teacherController.deleteTeachersBulk);
 ...
 */
router.delete('/department/:departmentId', verifyToken, requireManagement, teacherController.deleteTeachersByDepartmentId);
 ...
 *         description: Server error
 */
router.delete('/hard-delete/all', verifyToken, requireManagement, teacherController.hardDeleteAllTeachers);
 ...
 *         description: No teachers found
 */
router.delete('/hard-delete/bulk', verifyToken, requireManagement, teacherController.hardDeleteTeachersBulk);
 ...
 *         description: Teacher not found
 */
router.delete('/:id', verifyToken, requireManagement, teacherController.deleteTeacher);
 ...
 */
router.get('/:id/schedule', optionalAuth, teacherController.getTeacherSchedule);
...
router.get('/:id/schedule/excel', optionalAuth, teacherController.exportTeacherSchedule);
