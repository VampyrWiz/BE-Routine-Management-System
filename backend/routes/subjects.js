 ...
 */
router.get('/program/:programId', optionalAuth, getSubjectsByProgramId);
 ...
 *         description: Subject not found
 */
router.put('/:id', protect, authorize('hod', 'dhod'), updateSubject);
 ...
 */
router.delete('/bulk', protect, authorize('hod', 'dhod'), deleteSubjectsBulk);
 ...
 */
router.delete('/program/:programId', protect, authorize('hod', 'dhod'), deleteSubjectsByProgramId);
 ...
 *         description: Subject not found
 */
router.delete('/:id', protect, authorize('hod', 'dhod'), deleteSubject);
